...
> **文档集状态：设计定稿；M2 最小闭环已实现（2026-09-24）。** 本目录描述设计与协议；已实现范围见 [../README.md](../README.md) 的「当前状态与参与方式」。
...
| [adr/](./adr/) | 架构决策记录 ADR-0001~0020（含技术选型总览）。 |
| [research/](./research/) | 开源实现调研归档（2026-09-24）——7 个方向的竞品/组件实测调研，含对 ADR-0010/0011/0015 的校准。 |
...
- **决策引用**：一律引用 ADR 编号（ADR-0001 ~ ADR-0020），完整记录见 [adr/](./adr/)；文中不重新论证已定稿决策，只说明它在本文档中的落点。
